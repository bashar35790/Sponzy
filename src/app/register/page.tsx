...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center p-4 py-8">
      <div className="w-full max-w-lg bg-dark-card border border-dark-border rounded-3xl p-6 sm:p-8 shadow-2xl shadow-black/60 space-y-6">
        {/* Brand Header */}
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400">Choose your role and join the community</p>
        </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                ...
                className={`flex flex-col items-center text-center p-3.5 rounded-2xl border transition-all ${
                  role === 'USER'
                    ? 'border-brand-500 bg-brand-500/10 text-white shadow-md shadow-pink-500/10 ring-1 ring-brand-500'
              ...
              >
                ...
                <div className="flex items-center gap-1">
                  <span className="font-bold text-sm">Fan / Member</span>
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-brand-500/20 text-pink-400 flex items-center justify-center mb-2">
                  <Sparkles className="w-5 h-5" />
                </div>
                <div className="flex items-center gap-1">
                  <span className="font-bold text-sm">Content Creator</span>
